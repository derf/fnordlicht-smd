...
/* {{{ */ {
	...
	global_pwm.channels[3].target_brightness = parameters[4];
...
/* {{{ */ {
	...
	if (parameters[1]==0) {
		CHANNEL0_PWM = parameters[2];
	} else if (parameters[1]==1) {
		CHANNEL1_PWM = parameters[2];
	} else if (parameters[1]==2) {
		CHANNEL2_PWM = parameters[2];
	} else if (parameters[1]==3) {
		CHANNEL3_PWM = parameters[2];
	}
