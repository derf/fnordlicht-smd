 ...
 */
#define USB_CFG_VENDOR_NAME     'S', 'p', 'i', 'd', 'a', '.', 'n', 'e', 't'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'F', 'n', 'o', 'r', 'd', 'l', 'i', 'c', 'h', 't'
#define USB_CFG_DEVICE_NAME_LEN 10
/* Same as above for the device name. If you don't want a device name, undefine
 * the macros. See the file USBID-License.txt before you assign a name if you
 * use a shared VID/PID.
 */
#ifndef USBSERIALNUMBER
#define USB_CFG_SERIAL_NUMBER       'U', 'n', 'c', 'o', 'n', 'f', 'i', 'g', 'u', 'r', 'e', 'd'
#define USB_CFG_SERIAL_NUMBER_LEN   12
#else
#define USB_CFG_SERIAL_NUMBER       USBSERIALNUMBER
#define USB_CFG_SERIAL_NUMBER_LEN   USBSERIALNUMBERLEN
#endif //USBSERIALNUMBER
