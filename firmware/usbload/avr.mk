...
program-serial-%: %.hex
	$(AVRDUDE) $(AVRDUDE_FLAGS) -c $(SERIAL_PROG) -P $(SERIAL_DEV) -b $(AVRDUDE_BAUDRATE) -U flash:w:$<

program-serial-eeprom-%: %.eep.hex launch-bootloader
	$(AVRDUDE) $(AVRDUDE_FLAGS) -c $(SERIAL_PROG) -P $(SERIAL_DEV) -b $(AVRDUDE_BAUDRATE) -U eeprom:w:$<
